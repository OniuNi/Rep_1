...
def month_days_number(month):
    return monthrange(2022, month)[
        1]  # ar trebui sa acceptam ca parametru si anul ca sa putem diferentia an bisect sau nu... dar presupunem an curent
...
def days_til_birthday(
        birthday_date="25.12.2022"):  # am ales sa dau ca argument o data sub forma de string, ca: "zz.ll.aaaa"
...
def name_type(name):
    ...
    'Carmen',):  # probabil mai sunt si alte nume de fata care nu incep cu 'a', dar v-ati prins de idee
